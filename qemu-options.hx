...
DEF("pmtrace-output", HAS_ARG, QEMU_OPTION_pmtrace_output,
    "-pmtrace-output filename\n"
    "                Enable the physical memory tracing and specify the output file name\n", QEMU_ARCH_I386)
DEF("pmtrace-sample", HAS_ARG, QEMU_OPTION_pmtrace_sample,
    "-pmtrace-sample N\n"
    "                Record 1 out of every N physical memory accesses\n", QEMU_ARCH_I386)
DEF("biotrace-output", HAS_ARG, QEMU_OPTION_biotrace_output,
    "-biotrace-output filename\n"
    "                Enable the block io tracing and specify the output file name\n", QEMU_ARCH_I386)
DEF("biotrace-sample", HAS_ARG, QEMU_OPTION_biotrace_sample,
    "-biotrace-sample N\n"
    "                Record 1 out of every N block disk io accesses\n", QEMU_ARCH_I386)
DEF("biotrace-enable-data", 0, QEMU_OPTION_biotrace_enable_data,
    "-biotrace-enable-data\n"
    "                Enable the block disk io data tracing\n", QEMU_ARCH_I386)
